...
$query = "INSERT INTO customer (first_name, last_name, street_address, city, state, zip_code, email, phone_number, recorder_id) 
VALUES ('$FirstName', '$LastName', '$Street', '$City', '$State', '$Zip', '$Email', '$Phone', '$Recorder')";
-->


$query = "INSERT into partisipant SET first_name, last_name, gender, 
birthdate, stake, ward,  phone, email, school, grade, username, password VALUEs ('$FirstName', '$LastName', '$Gender', 
